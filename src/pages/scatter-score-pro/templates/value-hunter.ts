...
export const ValueHunterTemplate: ScatterScoreTemplate = {
  ...
  maxMetricsToShow: 20, // Max metrics that can be shown/added by user eventually
  ...
  metricSelectionStrategy: {
    minRequired: 8, // Min metrics to be initially displayed or enforced
    maxTotal: 15,   // Max metrics allowed by this strategy (could be <= maxMetricsToShow)
    priorityGroups: [

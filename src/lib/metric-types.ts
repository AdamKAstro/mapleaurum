...
import type { ColumnTier, CompanyStatus } from './types'; // ColumnTier is now 'free' | 'pro' | 'premium'
...
  tier: ColumnTier; // 'free' | 'pro' | 'premium' - UPDATED
...
// UPDATED all 'medium' tiers to 'pro'
export const metrics: MetricConfig[] = [
  // === Company Overview - Free Tier ===
  {
    key: 'company-overview.percent_gold',
    db_column: 'percent_gold', nested_path: 'percent_gold',
    label: 'Gold %', description: 'Percentage of production/resources as gold. Higher is better (↑) for gold-focused investors.',
...
    label: 'Silver %', description: 'Percentage of production/resources as silver. Higher is better (↑) for silver-focused investors.',
    unit: '%', higherIsBetter: true, category: 'company-overview', tier: 'free', format: 'percent'
  },
   {
    key: 'company-overview.share_price',
    db_column: 'share_price', nested_path: 'share_price',
    label: 'Share Price', description: 'Latest stock price ($). Higher is better (↑) for market strength.',
...
    label: 'Cash', description: 'Cash reserves ($M). Higher is better (↑) for financial flexibility.',
...
    label: 'Market Cap', description: 'Market capitalization ($M). Higher is better (↑) for company scale.',
    unit: '$M', higherIsBetter: true, category: 'financials', tier: 'free', format: 'currency'
  },
  {
    key: 'financials.enterprise_value_value',
    db_column: 'f_enterprise_value_value', nested_path: 'financials.enterprise_value_value',
    label: 'Enterprise Value', description: 'Market cap + debt - cash ($M). Higher is better (↑) for total valuation.',
    unit: '$M', higherIsBetter: true, category: 'financials', tier: 'free', format: 'currency'
  },
   {
    key: 'financials.net_financial_assets',
    db_column: 'f_net_financial_assets', nested_path: 'financials.net_financial_assets',
    label: 'Net Fin Assets', description: 'Assets minus liabilities ($M). Higher is better (↑) for health.',
    unit: '$M', higherIsBetter: true, category: 'financials', tier: 'free', format: 'currency'
  },
  {
    key: 'financials.shares_outstanding',
    db_column: 'f_shares_outstanding', nested_path: 'financials.shares_outstanding',
    label: 'Shares Outstanding', description: 'Issued shares (millions). Lower is better (↓) to minimize dilution.',
...
    label: 'P/B Ratio', description: 'Share price vs. book value. Lower is better (↓) for undervaluation.',
...
    label: 'P/S Ratio', description: 'Share price vs. revenue. Lower is better (↓) for value.',
    unit: 'x', higherIsBetter: false, category: 'financials', tier: 'pro', format: 'ratio'
  },
  {
    key: 'financials.enterprise_to_revenue',
    db_column: 'f_enterprise_to_revenue', nested_path: 'financials.enterprise_to_revenue',
    label: 'EV/Revenue', description: 'EV vs. revenue. Lower is better (↓) for efficiency.',
    unit: 'x', higherIsBetter: false, category: 'financials', tier: 'pro', format: 'ratio'
  },
  {
    key: 'financials.enterprise_to_ebitda',
    db_column: 'f_enterprise_to_ebitda', nested_path: 'financials.enterprise_to_ebitda',
    label: 'EV/EBITDA', description: 'EV vs. EBITDA. Lower is better (↓) for valuation.',
    unit: 'x', higherIsBetter: false, category: 'financials', tier: 'pro', format: 'ratio'
  },
  {
    key: 'financials.trailing_pe',
    db_column: 'f_trailing_pe', nested_path: 'financials.trailing_pe',
    label: 'Trailing P/E', description: 'Trailing price-to-earnings ratio. Lower is better (↓) for past value.',
    unit: 'x', higherIsBetter: false, category: 'financials', tier: 'pro', format: 'ratio'
  },
  {
    key: 'financials.forward_pe',
    db_column: 'f_forward_pe', nested_path: 'financials.forward_pe',
    label: 'Forward P/E', description: 'Forward price-to-earnings ratio. Lower is better (↓) for future value.',
    unit: 'x', higherIsBetter: false, category: 'financials', tier: 'pro', format: 'ratio'
  },
  {
    key: 'financials.revenue_value',
    db_column: 'f_revenue_value', nested_path: 'financials.revenue_value',
    label: 'Revenue', description: 'Annual revenue ($M). Higher is better (↑) for income strength.',
...
    label: 'Net Income', description: 'Net profit ($M). Higher is better (↑) for bottom-line success.',
    unit: '$M', higherIsBetter: true, category: 'financials', tier: 'pro', format: 'currency'
  },
  {
    key: 'financials.debt_value',
    db_column: 'f_debt_value', nested_path: 'financials.debt_value',
    label: 'Total Debt', description: 'Total debt ($M). Lower is better (↓) for reduced risk.',
...
    label: 'Free Cash Flow', description: 'Cash after operating expenses ($M). Higher is better (↑) for profitability.',
...
    label: 'EBITDA', description: 'Earnings before interest, taxes, etc. ($M). Higher is better (↑) for operating profit.',
    unit: '$M', higherIsBetter: true, category: 'financials', tier: 'premium', format: 'currency'
  },
...
    label: 'Existing Shares', description: 'Current shares outstanding (millions). Lower is better (↓) for ownership concentration.',
...
    label: 'Fully Diluted Shares', description: 'Shares including options/warrants (millions). Lower is better (↓) for future dilution.',
    unit: 'M', higherIsBetter: false, category: 'capital-structure', tier: 'pro', format: 'number'
  },
...
    label: 'ITM Options', description: 'Profitable exercisable options (millions). Lower is better (↓) for dilution risk.',
...
    label: 'Options Revenue', description: 'Revenue from options ($M). Higher is better (↑) for extra income.',
...
    label: 'Total Reserves', description: 'Gold-equivalent reserves (million ounces). Higher is better (↑) for asset base.',
...
    label: 'Total M&I', description: 'Measured/indicated resources (moz). Higher is better (↑) for potential.',
    unit: 'Moz', higherIsBetter: true, category: 'mineral-estimates', tier: 'pro', format: 'moz'
  },
  {
...
    label: 'Total Resources', description: 'Total Measured, Indicated, and Inferred gold equivalent ounces. Higher is better (↑) for scale.',
    unit: 'Moz', higherIsBetter: true, category: 'mineral-estimates', tier: 'pro', format: 'moz'
  },
   {
...
    label: 'Precious Reserves', description: 'Precious metal reserves (moz). Higher is better (↑) for value.',
    unit: 'Moz', higherIsBetter: true, category: 'mineral-estimates', tier: 'pro', format: 'moz'
  },
  {
...
    label: 'Precious M&I', description: 'Precious Measured & Indicated (moz). Higher is better (↑) for potential.',
    unit: 'Moz', higherIsBetter: true, category: 'mineral-estimates', tier: 'pro', format: 'moz'
  },
  {
...
    label: 'Precious Resources', description: 'Precious total resources (moz). Higher is better (↑) for value.',
    unit: 'Moz', higherIsBetter: true, category: 'mineral-estimates', tier: 'pro', format: 'moz'
  },
...
    label: 'Total Potential', description: 'Potential resources (moz). Higher is better (↑) for upside.',
...
    label: 'MC/Resource oz', description: 'Market cap per total resource ounce ($/oz). Lower is better (↓) for value.',
...
    label: 'MC/Reserve oz', description: 'Market cap per total reserve ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'pro', format: 'currency'
  },
  {
...
    label: 'MC/Prec Resource oz', description: 'Market cap per precious resource ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'pro', format: 'currency'
  },
  {
...
    label: 'MC/Prec Reserve oz', description: 'Market cap per precious reserve ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'pro', format: 'currency'
  },
...
    label: 'EV/Resource oz', description: 'EV per total resource ounce ($/oz). Lower is better (↓) for value.',
...
    label: 'EV/Reserve oz', description: 'EV per total reserve ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'premium', format: 'currency'
  },
  {
...
    label: 'EV/Prec Resource oz', description: 'EV per precious resource ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'premium', format: 'currency'
  },
  {
...
    label: 'EV/Prec Reserve oz', description: 'EV per precious reserve ounce ($/oz). Lower is better (↓) for value.',
    unit: '$/oz', higherIsBetter: false, category: 'valuation-metrics', tier: 'premium', format: 'currency'
  },
...
    label: 'Current Prod.', description: 'Current annual gold equivalent production (koz). Higher is better (↑) for output.',
...
    label: 'Reserve Life', description: 'Years of reserves at current production. Higher is better (↑) for longevity.',
...
    label: 'Precious Prod.', description: 'Precious metal production (koz). Higher is better (↑) for value.',
...
    label: 'Non-Precious Prod.', description: 'Non-precious production (koz). Higher is better (↑) for output.',
    unit: 'koz', higherIsBetter: true, category: 'production', tier: 'pro', format: 'koz'
  },
...
    label: 'Future Prod.', description: 'Estimated future annual gold equivalent production (koz). Higher is better (↑) for growth.',
...
    label: 'Future AISC', description: 'Projected All-In Sustaining Cost per ounce ($/oz). Lower is better (↓) for efficiency.',
...
    label: 'Construction Costs', description: 'Project construction costs ($M). Lower is better (↓) for efficiency.',
...
    label: 'Future TCO', description: 'Future total cash costs ($/oz). Lower is better (↓) for profit.',
    unit: '$/oz', higherIsBetter: false, category: 'costs', tier: 'premium', format: 'currency'
  },
  {
    key: 'costs.aisc_last_quarter',
    db_column: 'c_aisc_last_quarter', nested_path: 'costs.aisc_last_quarter',
    label: 'Last Qtr AISC', description: 'AISC last quarter ($/oz). Lower is better (↓) for performance.',
    unit: '$/oz', higherIsBetter: false, category: 'costs', tier: 'premium', format: 'currency'
  },
  {
    key: 'costs.aisc_last_year',
    db_column: 'c_aisc_last_year', nested_path: 'costs.aisc_last_year',
    label: 'Last Yr AISC', description: 'AISC last year ($/oz). Lower is better (↓) for efficiency.',
    unit: '$/oz', higherIsBetter: false, category: 'costs', tier: 'premium', format: 'currency'
  }
];
...
  const tierLevels: Record<ColumnTier, number> = { free: 0, pro: 1, premium: 2 }; // UPDATED medium to pro
